...
class MenuItem(object):
    ...
    def __init__(self, mtype, name, attributes=None, visible=True):
        self.type = mtype
        self.name = name
...
class MenuContext(object):
    ...
    def display(self, menuItem):
        # Tells the delegate to display the selection.
        # Advances to the next selection if the menuItem is visible==False
